 ...
 * Les informations de naissance, de genre et de décès sont immuables après
 * création.
 */
...
public abstract class Personne {
    ...
    private Personne conjoint; // Personne avec qui la personne est mariée
    ...
    public int getAge() {
        ...
        return Period.between(dateNaissance, fin).getYears(); // Retourne l'âge de la personne
    }
    ...
    public void seMarier(Personne nouveauConjoint) {
        if (nouveauConjoint == null || nouveauConjoint == this) { // Vérifie si le conjoint est null ou si la personne
                                                                  // est mariée avec elle-même
        ...
        if (this.getGenre() == Genre.FEMME) {
            System.out.println(this.getPrenom() + " " + this.getNomCourant() + " se marie avec "
                    + nouveauConjoint.getPrenom() + " " + nouveauConjoint.getNomCourant());
            this.setNomCourant(nouveauConjoint.getNomCourant()); // Met à jour le nom courant de la femme
    ...
    public void setDateDeces(LocalDate dateDeces) {
        if (this.dateDeces == null) {
            ...
            System.out.println(
                    "ERREUR : La date de décès de " + getPrenom() + " " + getNomCourant() + " est déjà définie.");
        }
    }
